...
<template>
  <div id="login-rectangle">
    <span style="font-size: 20px;font-weight: 700;position: absolute;left: 78px;top: 60px">RECOVER</span>

    <span style="font-size: 30px;font-weight: 700;position: absolute;left: 78px;top: 85px" >找回成功</span>
